...
1. At this point you should consider migrating [job traces](job_traces.md#how-to-migrate-archived-job-traces-from-object-storage-to-local-storage) as well.
