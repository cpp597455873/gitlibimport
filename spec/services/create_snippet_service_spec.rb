...
describe CreateSnippetService do
  ...
  context 'checking spam' do
    ...
    [true, false, nil].each do |trust_user_actions|
      context "when recaptcha_disabled flag is #{trust_user_actions.inspect}" do
        before do
          stub_feature_flags(trust_user_actions: trust_user_actions) unless trust_user_actions.nil?
        end
