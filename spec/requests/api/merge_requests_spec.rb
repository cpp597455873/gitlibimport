...
describe API::MergeRequests do
  ...
  describe "GET /projects/:id/merge_requests/:merge_request_iid" do
    ...
    context 'for forked projects' do
      ...
      it 'includes the `allow_collaboration` field', :sidekiq_inline_tech_debt do
        get api("/projects/#{project.id}/merge_requests/#{merge_request.iid}", user)
  ...
  describe 'POST /projects/:id/merge_requests' do
    ...
    context 'forked projects' do
      ...
      it 'allows setting `allow_collaboration`', :sidekiq_inline_tech_debt do
        post api("/projects/#{forked_project.id}/merge_requests", user2),
      ...
      it "returns 201 when target_branch is specified and for the same project", :sidekiq_inline_tech_debt do
        post api("/projects/#{forked_project.id}/merge_requests", user2),
