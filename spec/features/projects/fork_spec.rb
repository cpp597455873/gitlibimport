...
describe 'Project fork' do
  ...
  it 'forks the project', :sidekiq_inline_tech_debt do
    visit project_path(project)
  ...
  context 'maintainer in group' do
    ...
    it 'links to the fork if the project was already forked within that namespace', :sidekiq_inline_tech_debt do
