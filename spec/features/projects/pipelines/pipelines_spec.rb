    ...
    describe 'GET /:project/pipelines' do
      ...
      context 'when pipeline is cancelable' do
        ...
        context 'when canceling' do
          ...
          it 'indicated that pipelines was canceled', :sidekiq_inline_tech_debt do
      ...
      context 'when pipeline is retryable', :sidekiq_inline_tech_debt do
        let!(:build) do
          create(:ci_build, pipeline: pipeline,
                            stage: 'test')
        end
      ...
      context 'when pipeline is detached merge request pipeline' do
        ...
        shared_examples_for 'showing detached merge request pipeline information' do
          it 'shows detached tag for the pipeline, and the link of the merge request, and does not show the ref of the pipeline', :sidekiq_inline_tech_debt do
      ...
      context 'when pipeline is merge request pipeline' do
        ...
        shared_examples_for 'Correct merge request pipeline information' do
          it 'does not show detached tag for the pipeline, and shows the link of the merge request, and does not show the ref of the pipeline', :sidekiq_inline_tech_debt do
            within '.pipeline-tags' do
      ...
      context 'for generic statuses' do
        ...
        context 'when running' do
          ...
          context 'when canceling' do
            ...
            it 'indicates that pipeline was canceled', :sidekiq_inline_tech_debt do
              expect(page).not_to have_selector('.js-pipelines-cancel-button')
              expect(page).to have_selector('.ci-canceled')
            end
          end
        ...
        context 'when failed' do
          ...
          it 'has failed pipeline', :sidekiq_inline_tech_debt do
            expect(page).to have_selector('.ci-failed')
          end
        end
      end
