...
describe 'New issue', :js do
  ...
  context 'when identified as a spam' do
    ...
    context 'when trust_user_actions feature flag is false' do
      before do
        stub_feature_flags(trust_user_actions: false)
      end
    ...
    context 'when trust_user_actions feature flag is true' do
      before do
        fill_in 'issue_title', with: 'issue title'
        fill_in 'issue_description', with: 'issue description'
      end
